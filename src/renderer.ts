...
class Timing {
    constructor(readonly hours: number, readonly mins: number, readonly secs: number, readonly millis: number) { }
...
class Timer {
    ...
    constructor(readonly notifFreqMillis: number, readonly notifiers: Notifier[]) {
